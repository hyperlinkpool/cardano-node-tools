...
public enum KeyAndCertCommand {
	...
	,PAYMENT_ADDRESS(3)
	,STAKE_ADDRESS(4)
	,STAKE_POOL_CREATE_A_REGISTRATION_CERTIFICATE(5)
	,POOL_REGISTRATION_GENERATE_COLD_KEY_AND_COLD_COUNTER(6)
	,POOL_REGISTRATION_GENERATE_VRF_KEY_PAIR(7)
	,POOL_REGISTRATION_GENERATE_KES_KEY_PAIR(8)
	,POOL_REGISTRATION_GENERATE_CERTIFICATE(9)
	,EXIT(99)
	;
