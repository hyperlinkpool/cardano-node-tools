...
public class MessageKR {
	...
	static {
		...
		messageFormats.put("M00151", "현재 계좌에 ADA 잔고가 충분하지 않습니다. 10 ADA 정도 입금 후에 재시도 하시기 바랍니다.");
		...
		messageFormats.put("M00175", "BlockProducer가 아닙니다. BlockProducer가 아닐 경우, 관련 Key(KES singing key, Cold signing key, Cold Counter key)가 있다면 KES Rotation을 진행할 수 있습니다.");
