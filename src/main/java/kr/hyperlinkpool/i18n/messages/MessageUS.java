...
public class MessageUS {
	...
	static {
		...
		messageFormats.put("M00138", "\n"
				...
				+ "2. Withdrawal of Stake Key(You can get back the 2ADA registered as a deposit.)\n"
				+ "3. Delegate Stake Key to Pool\n"
				+ "4. Metadata JSON file creation\n"
				+ "5. Pool information registration(You must register stake key at first, and it takes 500 ADA at deposit. After that, it will be charged only transaction fee at modification.)\n"
				+ "6. Pool modification\n"
				+ "6. Withdrawal of Pool (You can get back the 500ADA registered as a deposit.)\n"
