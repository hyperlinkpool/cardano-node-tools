...
import kr.hyperlinkpool.command.poolregist.type.deregisterpoolstep.Step1;
import kr.hyperlinkpool.command.poolregist.type.deregisterpoolstep.Step2;
import kr.hyperlinkpool.command.poolregist.type.deregisterpoolstep.Step3;
import kr.hyperlinkpool.command.poolregist.type.deregisterpoolstep.Step4;
...
public class DeRegisterPoolHandler extends AbstractCommandHandler{
	...
	public ProcessResultDomain<ProcessResponse> handleCommand(Object... commands) {
		...
		boolean loop = true;
		DeRegisterPoolDomain deRegisterPoolDomain = new DeRegisterPoolDomain();
		ProcessResultDomain<DeRegisterPoolDomain> result = new ProcessResultDomain<DeRegisterPoolDomain>();
