...
import kr.hyperlinkpool.command.poolregist.type.registerstakestep.Step1;
import kr.hyperlinkpool.command.poolregist.type.registerstakestep.Step2;
import kr.hyperlinkpool.command.poolregist.type.registerstakestep.Step3;
...
public class RegisterStakeAddressOnTheBlockchainHandler extends AbstractCommandHandler{
	...
	public ProcessResultDomain<ProcessResponse> handleCommand(Object... commands) {
		...
		boolean loop = true;
		RegisterStakeDomain registerStakeDomain = new RegisterStakeDomain();
		ProcessResultDomain<RegisterStakeDomain> result = new ProcessResultDomain<RegisterStakeDomain>();
