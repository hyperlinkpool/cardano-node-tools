...
public class Step4 implements PoolModifyResult, Ordered, JobProcess{
	...
	public void run() {
		 ...
		 */
		poolModifyDomain.setSenderAddress(paymentAddressString);
		poolModifyDomain.setReceiveAddress(paymentAddressString);
		 ...
		 * TxOut
		 */
		txOut = CommandExecutor.getTxOutData(poolModifyDomain.getReceiveAddress(), sumLovelace);
		...
		if(poolModifyDomain.isTxFeeReCalc()) {
			txFee = poolModifyDomain.getTxFee();
		}
		...
		poolModifyDomain.setSumLovelace(sumLovelace);
		poolModifyDomain.setReceiverTotal(receiverTotal);
		poolModifyDomain.setSenderAddress(paymentAddressString);
		poolModifyDomain.setPoolDeposit(poolDeposit);
		poolModifyDomain.setTxIn(txIn);
		poolModifyDomain.setTxOut(txOut);
		poolModifyDomain.setTxFee(txFee);
