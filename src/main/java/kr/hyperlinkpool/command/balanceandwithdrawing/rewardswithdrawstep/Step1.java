...
public class Step1 implements RewardsWithdrawResult, Ordered, Runnable{
	...
	public void run() {
		...
		if(rewardsData.length() == 0) {
			MessagePrompter.promptMessage(MessageFactory.getInstance().getMessage("Stake Key가 생성되지 않았습니다. 키 생성 후 다시 시도하세요.", "M00002"), true);
